...
public class ServerImpl extends UnicastRemoteObject implements Server {
    ...
    /**
     * @return Riferimento del controller.
     */
...
//            serverController.getConsoleLogs().setScrollTop(serverController.getConsoleLogs().getScrollTop());
    ...
    private synchronized boolean addClient(Client remoteClient) throws RemoteException {
        if(!listClients.contains(remoteClient)){
            ...
            System.out.println("Numero di client attualmente connessi: " + (++numConnessioni) + "\n");
            getServerController().getCounterClientLabel().setText(listClients.size() + "");
//                serverController.getCounterClientLabel().appendText(listClients.size() + "");
